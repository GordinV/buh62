...
*	lcFile = 'c:\avpsoft\vara\154000maa.dbf'
*	lcFile = 'c:\avpsoft\vara\154000hoone2.dbf'
*	lcFile = 'c:\avpsoft\vara\154000korter2.dbf'
*	lcFile = 'c:\avpsoft\vara\155100hoone2.dbf'
*	lcFile = 'c:\avpsoft\vara\155106tee.dbf'
*	lcFile = 'c:\avpsoft\vara\155109rajatised.dbf'
*	lcFile = 'c:\avpsoft\vara\155101korter2.dbf'
*	lcFile = 'c:\avpsoft\vara\155400seadmed.dbf'
*	lcFile = 'c:\avpsoft\vara\155405auto.dbf'
*	lcFile = 'c:\avpsoft\vara\155500ARV1.dbf'
	lcFile = 'c:\avpsoft\vara\155600muu.dbf'
	If !File(lcFile)
...
*	lnvastIsikId = 45
	...
	Use (lcFile) In 0 Alias qryKaart
	Select qryKaart
...
*  uus pv
			...
			lcMark = lcMark + Iif(!Empty(qryKaart.n13),'Mхtlemine osa '+ Ltrim(Rtrim(qryKaart.n13))+Chr(13),'')
