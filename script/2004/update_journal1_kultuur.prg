...
IF lnResult > 0
	...
	SCAN
		...
		lcString = "update journal1 set tunnus = '"+lcTunnus+"', kood1 = '"+lcTT+"' where deebet = '506040' and kreedit = '203030' "+;
		" and parentid in (select journalid from palk_oper where MONTH(kpv) < 3 and rekvid = 13 and journalid > 0 and "+;
