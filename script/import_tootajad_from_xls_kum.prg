...
Function import_tootajad
	...
	Select * From kum Into Cursor curTt
...
* check for name in asutus
		...
		lcNimi = Trim(curTt.b)
		lcAadress = ''
		lcAmet = Alltrim(curTt.d)
		lcOsakond = Alltrim(curTt.c)
		lcAlgKpv = ''
		lcAa = Alltrim(STR(curTt.f,16))
		lcpalk = Alltrim(STR(curTt.j))
		lcPohikoht = Alltrim(STR(curTt.i,1))
		lcpank = Iif(Left(lcAa,2) = '33','722',Iif(Left(lcAa,4) = '1056','401','767'))
		lcKoormus = Alltrim(STR(curTt.l,12,4))
