...
*SET STEP ON 
gnHandle2009 = SQLConnect('hooldekodu','vlad','490710')
gnHandle2008 = SQLConnect('hooldekodu2009','vlad','490710')
If gnHandle2009 < 1
...
lcKpv = 'date(2010,01,01)'
lcKpv2 = 'date(2009,12,31)'
select qryRekv
scan
	...
	* Tellime saldoandmik
	...
	lcString  = " select sp_saldoandmik_report("+ Str(qryRekv.id)+","+lcKpv2+",0,0)"
...
*		select * from qrySaldoKreedit1 into cursor qrySaldoKreedit
	...
	* kustutame vana lausend
	...
	lcString = "delete from journal where rekvid = " + str(qryrekv.id,9)+ " and kpv = date(2009,12,31) and selg like 'Alg.saldo%'"
