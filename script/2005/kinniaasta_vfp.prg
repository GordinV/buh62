...
Function f_loppsaldo
	...
	select * from curjournal_ where kpv < DATE(2005,01,01) INTO CURSOR qryKaibed
...
FUNCTION fdeldok
		...
		update arv set journalid = 0 where kpv < date(2005,01,01) 
		update mk set journalId = 0 where kpv < date(2005,01,01) 
		update korder1 set journalId = 0 where kpv < date(2005,01,01)
		update palk_oper set journalId = 0 where kpv < date(2005,01,01)
		update avans1 set journalId = 0 where kpv < date(2005,01,01) 
		update pv_oper set journalId = 0 where kpv < date(2005,1,1) and parentid in (select id from curPohivara_)
		update vanemtasu3 set journalId = 0 where kpv < date(2005,1,1) 
		delete from journal where kpv < date(2005,1,1)
