...
* lisamine
	...
	Replace Id With 202,;
		objekt With 'Aruanne',;
		nimetus1 With 'Saldoteatis ',;
		nimetus2 With 'Saldoteatis ',;
		procfail With 'saldoAsutusandmik_report1',;
		reportfail With 'saldoAsutusandmik_report2',;
		reportvene With 'saldoAsutusandmik_report2' In curPrinter
Endif
...
*				lcdataproc = lcdefault+'\tmp\buhdata5_20041231.prn'
*!*					If File (lcdataproc)
...
*!*	SET STEP ON 
*!*		lcFile = 'tmp/fnc_muudatused20041231.sql'
