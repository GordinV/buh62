...
* menu records
	...
	If !Found()
		Insert Into menupohi (omandus, proc_, level_, Pad, Bar) Values ;
			('RUS CAPTION=Проекты'+Chr(13)+'EST CAPTION=Projektid',;
	...
	If !Found()
		Insert Into menupohi (omandus, proc_, level_, Pad, Bar) Values ;
			('RUS CAPTION=Мероприятия'+Chr(13)+'EST CAPTION=Ьritused',;
...
*menu
	...
	lError = sqlexec(gnHandle,lcString,'qrymenupohi')
		...
		lcOmandus = 'RUS CAPTION=Проекты'+Chr(13)+'EST CAPTION=Projektid'
	...
	If Reccount('qrymenupohi') < 1
		...
		lcOmandus = 'RUS CAPTION=Добавить запись'+Chr(13)+'EST CAPTION=Lisamine'
...
* edit
		lcOmandus = 'RUS CAPTION=редактировать'+Chr(13)+'EST CAPTION=Muutmine'
...
* kustuta
		lcOmandus = 'RUS CAPTION=Удалить'+Chr(13)+'EST CAPTION=Kustutamine'
...
* print
		lcOmandus = 'RUS CAPTION=Печать'+Chr(13)+'EST CAPTION=Trьkkimine'
	...
	lError = sqlexec(gnHandle,lcString,'qrymenupohi')
		...
		lcOmandus = 'RUS CAPTION=Мероприятия'+Chr(13)+'EST CAPTION=Ьritused'
...
Function update_tolk
	...
	If lnCount < 1
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('projektid','.grid.column1.header1','Код','Kood')
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('projektid','.grid.column2.header1','Наименование','Nimetus')
	Endif
	Count To lnCount For objektid = 'proj'
	If lnCount < 1
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('proj','.lblKood','Код:','Kood:')
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('proj','.lblNimetus','Наименование:','Nimetus:')
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('proj','.lblMuud','Примечание:','Mдrkused:')
	Endif
	Count To lnCount For ALLTRIM(LOWER(objektid)) = 'operatsioon'
	If lnCount < 45
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('OPERATSIOON','.Grid1.Column11.Header1','Проект','Projekt')
		Insert Into tolk (objektid, objekt, captionorg, captionsub) Values ('OPERATSIOON','.Grid1.Column12.Header1','Меропр.','Ьritus')
	Endif
