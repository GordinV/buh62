...
SELECT Eelarve.id, Eelarve.rekvid, Eelarve.aasta, Eelarve.summa,;
  Eelarve.kood1, Eelarve.kood2, Eelarve.kood3, Eelarve.kood4, Eelarve.kood5,;
  Eelarve.tunnus AS tun, Rekv.nimetus, Rekv.nimetus AS asutus,;
  Rekv.regkood, Rekv.parentid, eelarve.kuu, eelarve.kpv,;
