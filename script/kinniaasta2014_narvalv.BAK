...
gnHandle2008 = SQLConnect('narvalv2012','vlad','Vlad490710')
If gnHandle2009 < 1
...
* asutuse nimekirje
lcString = "select id, nimetus from rekv where parentid < 999 and id <> 63 and id = 3 " 
*!*	and "+;
...
*		select * from qrySaldoKreedit1 into cursor qrySaldoKreedit
	...
	* kustutame vana lausend
	...
	lcString = "delete from journal where rekvid = " + str(qryrekv.id,9)+ " and kpv = date(2012,12,31) and selg like 'Alg.saldo%'"
