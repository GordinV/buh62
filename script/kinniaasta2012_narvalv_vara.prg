...
* asutuse nimekirje
lcString = "select id, nimetus from rekv where id in (6) " 
*!*	and "+;
...
*!*		endif
	...
	lcString = "select algjaak, konto, asutusId from tmp_subkontod_report where left(konto,6) in('102160') and timestamp = '"+tcTimestamp+"' order by konto, asutusid" 
