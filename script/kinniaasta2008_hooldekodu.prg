...
gnHandle2004 = SQLConnect('hooldekodu2007')
If gnHandle2004 < 1
	Messagebox('Viga,gnHandle2004')
	Return
Endif

gnHandle2005 = SQLConnect('hooldekodu')
...
*		Return lnError
	...
	lcString = 'select * from curjournal where kpv < DATE(2008,01,01) and rekvid = '+Str(tnRekvId)
