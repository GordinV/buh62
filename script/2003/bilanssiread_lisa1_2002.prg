...
insert into scrBilanss (nimetus, rea, konto) values ('Aktsiad ja muud väärtpaberid','2','SD(181)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Nõuded töötajatele','4.1','SD(151)')
insert into scrBilanss (nimetus, rea, konto) values ('Mitmesugused lühiajalised nõuded','4.2','SD(154)+SD(155)+SD(156)+SD(158)')
insert into scrBilanss (nimetus, rea, konto) values ('Ebatõenaoliselt laekuvad  nõuded ostjatelt (miinus)','4.3','-1 * SD(159)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Ettemakstud rendi/üürikulud ','6.1','SD(161)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Varud, lõpetamata toodang ja tööd, ettemaksed hankijatele','7','')
insert into scrBilanss (nimetus, rea, konto) values ('Tooraine ja materjali varu','7.1','SD(131)')
insert into scrBilanss (nimetus, rea, konto) values ('Lõpetamata toodangu varu','7.2','SD(134)')
insert into scrBilanss (nimetus, rea, konto) values ('Valmistoodang','7.3','SD(135)+SD(136)')
insert into scrBilanss (nimetus, rea, konto) values ('Lõpetamata töö','7.4','SD(137)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Võlakirjad ja muud väärtpaberid','8.2','SD(122)')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajalised nõuded','8.3','SD(123)+SD(124)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Muu inventar, tööriistad, sisseseade ja muud (soetusmaksumus)','9.3','SD(113)+SD(114)+SD(115)+SD(116)+SD(117)+SK(1139)+SK(1149)+SK(1159)+SK(1179)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Lõpetamata ehitus','9.5', 'SD(118)')
insert into scrBilanss (nimetus, rea, konto) values ('Materiaalsete põhivarade ettemaksed','9.6', 'SD(119)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Arenguväljaminekud','10.2', 'SD(102)')
insert into scrBilanss (nimetus, rea, konto) values ('Ostetud patendid, litsentsid, kontsessioonid, kaubamärgid, rendiõigus jne.','10.3', 'SD(103)+SD(104)+SD(107)+SD(109)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Lõhiajalised laenud','11.1', 'SK(242)')
insert into scrBilanss (nimetus, rea, konto) values ('Lühiajalised kohustused asutustele','11.2', 'SK(244)')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajaliste kohustuste lühiajaline osa','11.3', 'SK(243)')
insert into scrBilanss (nimetus, rea, konto) values ('Lühiajaline võlakirjade emiteerimine','11.4', 'SK(245)')
insert into scrBilanss (nimetus, rea, konto) values ('Võlad tarnijatele','11.5', 'SK(247)+SK(248)')
insert into scrBilanss (nimetus, rea, konto) values ('Muud lühiajalised kohustused','11.6', 'SK(240)+SK(241)+SK(249)+SK(281)+SK(289)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Kohustused töötajatele','15.1', 'SK(292)')
insert into scrBilanss (nimetus, rea, konto) values ('Intressivõlad','15.2', 'SK(293)')
insert into scrBilanss (nimetus, rea, konto) values ('Muud viitvõlad','15.3', 'SK(297)')
insert into scrBilanss (nimetus, rea, konto) values ('Muud ettemakstud tulevaste perioodide tulud','15.4', 'SK(298)+SK(299)')
insert into scrBilanss (nimetus, rea, konto) values ('Lühiajalised eraldised','16', '')
insert into scrBilanss (nimetus, rea, konto) values ('Lühiajalised eraldised','16.1', 'SK(223)')
*!*	insert into scrBilanss (nimetus, rea, konto) values ('Lühiajalised kohustused kokku','17', '')
*!*	insert into scrBilanss (nimetus, rea, konto) values ('Lühiajalised kohustused kokku','17.1', 'REA')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajalised võlakohustused','18', '')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajalised deposiidid','18.1', 'SK(231)')
insert into scrBilanss (nimetus, rea, konto) values ('Võlg liisingfirmadele','18.2', 'SK(234)')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajalised tarnijakrediidid','18.3', 'SK(235)')
insert into scrBilanss (nimetus, rea, konto) values ('Pikaajaliste võlakirjade emiteerimine','18.4', 'SK(237)')
...
insert into scrBilanss (nimetus, rea, konto) values ('Bilansivälised kirjed','22', '')
insert into scrBilanss (nimetus, rea, konto) values ('Bilansiväliselt arvestatava vara maksumus','22.1', '')
insert into scrBilanss (nimetus, rea, konto) values ('Erastamise väärtpaberid ','22.2', '')
insert into scrBilanss (nimetus, rea, konto) values ('Bilansivälises arvestuses olevad lootusetud nõuded','22.3', '')
