...
create cursor fltrVara (grupp c(20), dok c(20),kood c(20), nimetus c(120))
append blank

DO queries\varade_report1

IF !empty (alias())
	BROW
ENDIF
report form reports\varade_report1 prev
if !used ('curPrinter')
	use curprinter in 0
endif
select curprinter
locate for 	procfail = 'varade_report1'
if !found ()
