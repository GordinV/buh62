...
*!*				If lnElement > 0
*!*	* found
*!*					lnRowNr = Asubscript(laFields, lnElement, 1)
*!*	* change
*!*					laFields[lnRowNr,1] = 'Nimetus'
*!*				ENDIF
*!*				SET STEP ON 
*!*				lnElement =  Ascan(laFields,"KOOD")
*!*				If lnElement > 0
*!*	* found
*!*					lnRowNr = Asubscript(laFields, lnElement, 1)
*!*	* change
*!*					laFields[lnRowNr,3] = 20
*!*				Endif

			Create Cursor (tcView) From Array laFields
			Select (tcView)
			APPEND FROM DBF('tmpQuery')
			USE IN tmpQuery
		Else
