...
lcModel = 'libs\libraries\maksukood'
...
Function test_of_selectAsLibs_model
	l_cursorName = 'comMaksukoodRemote'
	With oDb
...
* expect LIBRARY
	...
	If Type('lcNotValidFields') = 'C'
		...
		Replace Id With 0, rekvid With gRekv, kood With '__test' + Left(Alltrim(Str(Rand() * 10000)),10),;
			nimetus With 'vfp test maksukood',;
			library With 'MAKSUKOOD'
	Endif
...
Function test_of_grid_model
	Local cursorName
	cursorName  = 'tmpMaksukood'
	With oDb
		Local lcWhere
		lcWhere = "kood ilike 'test%'"
		lcAlias = 'curMaksukood'
* parameters
