...
lcModel = 'raamatupidamine\leping'
...
WITH oDb
	LOCAL lcWhere
	lcWhere = "number ilike '01%'"
	lcAlias = 'curLepingud'
	* parameters
		lError = oDb.readFromModel(lcModel, lcAlias, 'gRekv, guserid', 'tmpLepingud', lcWhere)

	IF 	!lError OR !USED('tmpLepingud')
		MESSAGEBOX('test failed',0 + 48,'Error')
		RETURN .f.
	ELSE 
		* success
