...
public gnHandle,gnHandleAsync, gcWindow, gRekv,gUserId, oPrintform2, oFinder, gReturn, oAsutused, oUserid,;
	oArved, oDokLausend, oNomenklatuur, oKOrderid, oKontod, oAllikad, oArtikkel, oTegev,;
	...
	gVersia, gcDatabase, glError, oRI, oConnect, oMenu, gcKey, gcAmetnik, gcPrognimi, oAutod, oTeenused
glError = .f.
gVersia = 'MSSQL'
gdKpv = date()
cKasutaja = ''
...
*!*	grekv = 1
*!*	gUserid = 1
ccAption = 'Raamatupidamine 6.0 Autoteenindus'
Local lError
Close data all
