-- Function: public.gen_lausend_korder(int4)

-- DROP FUNCTION public.gen_lausend_korder(int4);
...
begin
	...
	Insert Into journal (rekvid, Userid, kpv, Asutusid, selg, muud) Values 	(v_korder1.rekvId, 0, v_korder1.kpv, v_korder1.AsutusId, v_dokprop.selg, \'AUTOMATSELT LAUSEND (GEN_LAUSEND_KORDER)\' );
