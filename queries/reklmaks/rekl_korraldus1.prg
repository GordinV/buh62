...
Create Cursor print_teatis (number c(20), regkood c(20), asutus c(254), aadress m, tel c(120), faks c(120), email c(120),;
	kood c(20), nimetus c(254), maksumaar N(12,2), soodus N(12,2), kogus N(12,4), Summa N(12,2),summa1 n(12,2),;
...
INSERT INTO print_teatis (number, regkood , asutus , aadress , tel, email , faks,;
	kood , nimetus , maksumaar, soodus, kogus , Summa , summa1, muud, kvartal, lubakpv, teatiskpv, deklkpv, valuuta, kuurs) VALUES;
	(tmpLuba.number, tmpAsutus.regkood, tmpAsutus.nimetus, tmpAsutus.aadress, tmpAsutus.tel, tmpAsutus.email,;
	 ...
	 tmpLuba.summa,tmpToiming.summa, tmpLuba1.muud, ;
	lnKvartal, tmpluba.algkpv, tmpToiming.kpv, ldKpv, tmpToiming.valuuta, tmpToiming.kuurs )
