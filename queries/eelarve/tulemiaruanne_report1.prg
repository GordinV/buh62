...
&&		lcParentNimi = ''
	...
	INSERT into tulemiaruanne_report1 (Nimetus, regkood, kbmkood, aadress, tel,;
		...
		v_tulem.Nimetus)
ENDSCAN
SELECT parentrea, parentnimi from tulemiaruanne_report1;
...
SCAN
	...
	IF lnCount > 1
		SCAN
			IF  parentrea = cursorParent1.parentrea and;
...
&&		lnAlg = analise_formula(alltrim(tulemiaruanne_report1.konto),fltrAruanne.kpv1, 'cursorAlgSaldo')
	...
	ENDIF
	SELECT tulemiaruanne_report1
	SUM algperiod for tulemiaruanne_report1.parentrea = cursorParent1.parentrea to lnAlg
	SUM loppperiod for tulemiaruanne_report1.parentrea = cursorParent1.parentrea to lnLopp
