...
SELECT 'S' as is_esita, ;
	...
	sum(tegelik) as tegelik, sum(kassa) as kassa, sum(saldoandmik) as saldoandmik ;
	FROM qryReport ;
	where alltrim(tegev) in ('01111','01112','01600','01700','01110','01120','01130','01210','01220','01310','01320','01330','01400','01500') ;
	INTO CURSOR tmp1
...
UPDATE eelarve_report_query  ;
	...
	WHERE ALLTRIM(tegev) in ('08102','08103','08105','08106','08107','08108','08109','08201','08202','08203',;
		'08204','08205','08206','08207','08208','08209','08210','08211','08212','08236','08300','08400','08500','08600') 
...
INSERT into eelarve_report_query (idx , sub_idx, is_esita , rekvid, tegev, artikkel, nimetus ,;
	eelarve , eelarve_kassa, eelarve_taps , eelarve_kassa_taps, tegelik , kassa, saldoandmik ) ;
VALUES ('8.10', 1, 'N', gRekv , space(20), '', UPPER('Aasta alguse seisuga') , ;
	0,; 
	0,; 
	0, ;
	0, ;
...
* kontrol
CREATE CURSOR kontrol_report (rea_1 c(254), rea_2 c(254), rea_3 c(254), rea_4 c(254), rea_5 c(254), summa_11 n(14,2), summa_12 n(14,2), summa_21 n(14,2), summa_22 n(14,2),;
 summa_31 n(14,2), summa_32 n(14,2), summa_41 n(14,2), summa_42 n(14,2),  summa_51 c(20), summa_52 c(20))
...
l_result_kassa =  get_kontrol ('','1000','','kassa') + get_kontrol ('','100','','kassa') - get_kontrol ('','1001','','kassa')
l_result_saldo =  get_kontrol ('','1000','','saldoandmik') + get_kontrol ('','100','','saldoandmik') - get_kontrol ('','1001','','saldoandmik')


replace rea_1 WITH 'likviidsed varad', summa_11 WITH l_result_kassa, summa_12 WITH l_result_saldo  IN kontrol_report 


* majandusliku sisu ja tegevusalade võrdlus 

l_result_kassa =  get_kontrol ('','50','','kassa') + get_kontrol ('','15','','kassa') + get_kontrol ('','4502','','kassa') + ;
	get_kontrol ('','1501','','kassa') + get_kontrol ('','1511','','kassa') + get_kontrol ('','1531','','kassa')+  get_kontrol ('','650','','kassa') +;
	get_kontrol ('3.1-5-0','','','kassa')
	
l_result_saldo =  get_kontrol ('','50','','saldoandmik') + get_kontrol ('','15','','saldoandmik') + get_kontrol ('','4502','','saldoandmik') + ;
	get_kontrol ('','1501','','saldoandmik') + get_kontrol ('','1511','','saldoandmik') + get_kontrol ('','1531','','saldoandmik')+  get_kontrol ('','650','','saldoandmik') +;
	get_kontrol ('3.1-5-0','','','saldoandmik')

replace rea_2 WITH ' majandusliku sisu ja tegevusalade võrdlus', summa_21 WITH l_result_kassa, summa_22 WITH l_result_saldo  IN kontrol_report 

* võlakohustused
l_result_kassa =  get_kontrol ('2.4.6-5-2','','','kassa') + get_kontrol ('','2580','','kassa') - get_kontrol ('','2581','','kassa')
l_result_saldo =  get_kontrol ('2.4.6-5-2','','','saldoandmik') + get_kontrol ('','2580','','saldoandmik') - get_kontrol ('','2581','','saldoandmik')

replace rea_3 WITH ' võlakohustused', summa_31 WITH l_result_kassa, summa_32 WITH l_result_saldo  IN kontrol_report 

* Tasakaalu kontroll

l_result_kassa =  get_kontrol ('2.4.6-5-1','','','kassa') +  get_kontrol ('2.4.6-5-2','','','kassa') - get_kontrol ('','100','','kassa') + get_kontrol ('2.4.8-5-2','','','kassa') 
l_result_saldo =  get_kontrol ('2.4.6-5-1','','','saldoandmik') +  get_kontrol ('2.4.6-5-2','','','saldoandmik') - get_kontrol ('','100','','saldoandmik') + get_kontrol ('2.4.8-5-2','','','saldoandmik') 

replace rea_4 WITH ' Tasakaalu kontroll', summa_41 WITH l_result_kassa, summa_42 WITH l_result_saldo  IN kontrol_report 


* Art. 100 ja vaba jäägi võrdlus (read 162 ja 52)
l_result_kassa =  IIF(get_kontrol ('','1000','','kassa') <  (-1 * get_kontrol ('','100','','kassa')), 'FALSE', 'OK') 
l_result_saldo =  IIF(get_kontrol ('','1000','','saldoandmik') <  (-1 * get_kontrol ('','100','','saldoandmik')), 'FALSE', 'OK')

replace rea_5 WITH 'Art. 100 ja vaba jäägi võrdlus ', summa_51 WITH l_result_kassa, summa_52 WITH l_result_saldo  IN kontrol_report 
...
SELECT sum(kassa) as kassa, sum(saldoandmik) as saldoandmik ;
FROM eelarve_report_query ;
