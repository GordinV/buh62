...
Select idx, allikas, tegev, artikkel, rahavoog, nimetus, tunnus,;
	...
	GROUP By allikas, tegev, idx, artikkel, rahavoog, tunnus, nimetus, regkood, asutus, parasutus,parregkood,report_kokku.rekv_id;
