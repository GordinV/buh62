...
* Eelarve kulude majanduliku ja üksuste sisu järgi   
...
Select r.artikkel, r.nimetus, Sum(r.eelarve) As eelarve, Sum(Iif(Empty(fltrAruanne.kassakulud), r.tegelik, r.kassa)) As taitmine,;
	r.regkood, r.asutus , r.tunnus, ;
	r.parasutus, r.parregkood ;
	from tmpReport r;
	GROUP By r.tunnus, r.artikkel, r.nimetus, r.regkood, r.asutus, r.parasutus,r.parregkood ;
	ORDER By r.parasutus, r.asutus,  r.artikkel, r.tunnus ;
