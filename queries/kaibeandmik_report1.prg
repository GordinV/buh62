...
lError = oDb.readFromModel('aruanned\raamatupidamine\kaibeandmik', 'kaibeandmik_report', 'fltrAruanne.kpv1,fltrAruanne.kpv2, gRekv,l_kond,l_tunnus', 'tmpReport', lcWhere)
If !lError
