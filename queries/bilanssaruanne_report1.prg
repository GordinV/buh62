...
WITH oDb
*!*		IF gVersia = 'PG'	
*!*			lError = .exec ("sp_saldo ",str(grekv)+", "+str(Month(dKpv1),2)+","+str(Year(dKpv1),4)+",'%'::varchar", 'cursorAlgSaldo' )
*!*			lError = .exec ("sp_saldo ",str(grekv)+", "+str(Month(dKpv2),2)+","+str(Year(dKpv2),4)+",'%'::varchar", 'cursorLoppSaldo' )
*!*		ELSE
