...
lError = oDb.readFromModel('aruanned\eelarve\asutuse_eelnou', 'asutuse_eelnou', 'fltrAruanne.kpv2, gRekv, fltrAruanne.kond', 'tmpReport', lcWhere)
If !lError
