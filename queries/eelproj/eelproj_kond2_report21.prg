...
If gVersia <> 'PG'
	...
	*		wait window 'Serveri poolt funktsioon ...' nowait
		...
		If Used('qryEelarve1')
			...
			lcString = "select Eelarve, Nimetus, summa1, summa2, summa3, summa4, summa5, summa6, summa7, summa8, summa9,"+;
				" summa1+summa2+summa3+summa4+summa5+summa6+summa7+summa8+summa9 as summa10 "+;
