...
set step on
	...
	*		wait window 'Serveri poolt funktsioon ...' nowait
		...
		If Used('qryEelarve1')
			...
			lcString = "select  Eelarve, Nimetus, summa1, summa2, summa3, summa4 "+;
				"  from tmp_eelproj_aruanne1 where (summa1 <> 0 or summa2 <> 0 or summa3 <> 0 or summa4 <> 0) and rekvid = "+str(gRekv)+;
