...
Local lnDeebet, lnKreedit
	Create Cursor KaibeAsutusAndmik_report1 (algsaldo N(12,2),deebet N(12,2),;
		kreedit N(12,2),konto c(20), nimetus c(120), asutus c(120), Asutusid Int, regkood c(20), tunnus c(20), tp c(20), subrekvid int, subrekvnim c(254) null)
	Index On Asutusid Tag Asutusid
	Index On Left (Upper (asutus),40) Tag asutus
	Index On Alltrim(Upper(asutus))+':' + Alltrim(konto)+':' + Alltrim(tunnus) Tag klkonto
