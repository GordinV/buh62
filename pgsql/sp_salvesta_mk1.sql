...
select sp_salvesta_mk1(369651::int,78230::int,17885::int,20134::int,1000.00::numeric,''::varchar,''::varchar,''::varchar,''::varchar,''::varchar,''::varchar,'300'::varchar,'103000'::varchar,'800599'::varchar,''::varchar,'EEK'::varchar,1.00::numeric,1::int)

*/

-- DROP FUNCTION sp_salvesta_mk1(integer, integer, integer, integer, numeric, character varying, character varying, integer, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying);
...
if tnId = 0 then
	...
	insert into mk1 (parentid,asutusid,nomid,summa,aa,pank,kood1,kood2,kood3,kood4,kood5,konto,tp,tunnus,proj) 
		values (tnparentid,tnasutusid,tnnomid,tnsumma,tcaa,tcpank,tckood1,tckood2,tckood3,tckood4,tckood5,tckonto,tctp,tctunnus,space(1));
