...
DROP FUNCTION if exists sp_salvesta_palk_kaart(integer, integer, integer, integer, numeric, integer, integer, integer, integer, text, integer, integer, character varying, numeric, integer);
DROP FUNCTION if exists sp_salvesta_palk_kaart(integer, integer, integer, integer, numeric, integer, integer, integer, integer, text, integer, integer, character varying, numeric);
