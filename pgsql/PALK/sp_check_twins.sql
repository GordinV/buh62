-- Function: public.sp_check_twins(date, integer, integer, integer)

-- DROP FUNCTION public.sp_check_twins(date, integer, integer, integer);

CREATE OR REPLACE FUNCTION sp_check_twins(
    date,
    integer,
    integer,
    integer)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.sp_check_twins(date, integer, integer, integer)
  OWNER TO vlad;
