-- Function: public.sp_calc_sots(integer, integer, date)

-- DROP FUNCTION public.sp_calc_sots(integer, integer, date);

CREATE OR REPLACE FUNCTION public.sp_calc_sots(
    integer,
    integer,
    date)
  RETURNS numeric AS
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.sp_calc_sots(integer, integer, date)
  OWNER TO vlad;
