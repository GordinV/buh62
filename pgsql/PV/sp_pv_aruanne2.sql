...
SELECT * FROM  tmp_pv_aruanne1  where timestamp = '201111254535139' Order By grupp, kood
...
begin
	...
	raise notice ' lisamine  ';
		...
		create table tmp_pv_aruanne1 (id int, kood varchar(20), nimetus varchar(254), konto varchar(20), grupp varchar(254),
			soetkpv date, 
			soetmaks numeric(18,6), algkulum numeric(18,6), kulum numeric(18,6), kulukokku numeric(18,6),kulumkokku numeric(18,6),
