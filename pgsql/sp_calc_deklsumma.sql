...
$BODY$
  ...
  COST 100;
ALTER FUNCTION sp_calc_deklsumma(integer, date) OWNER TO vlad;
GRANT EXECUTE ON FUNCTION sp_calc_deklsumma(integer, date) TO vlad;
GRANT EXECUTE ON FUNCTION sp_calc_deklsumma(integer, date) TO public;
...
GRANT EXECUTE ON FUNCTION sp_calc_deklsumma(integer, date) TO taabel;
