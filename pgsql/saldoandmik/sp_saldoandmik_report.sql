...
lcKonto = '';
	...
	from 
	(
	SELECT  journal1.deebet AS konto, journal1.lisa_d::varchar as tp, 
	...
	UNION ALL 
		SELECT  journal1.kreedit AS konto, journal1.lisa_k::varchar as tp,
		journal1.kood2 as allikas,journal1.kood1 as tegev, journal1.kood3 as rahavoo, journal1.kood5 as eelarve,
...
for v_saldo in 
	...
	from 
	(
	SELECT journal1.deebet As konto, journal1.lisa_d::varchar As tp, journal1.kood1 As tegev, journal1.kood2 As allikas, journal1.kood3 As rahavoo, 
...
from 
(
	SELECT journal1.kreedit As konto, journal1.lisa_k::varchar As tp, journal1.kood1 As tegev, journal1.kood2 As allikas, journal1.kood3 As rahavoo, 
...
INSERT INTO tmp_saldoandmik (konto, tp, tegev, allikas, rahavoo, db, kr, rekvid, timestamp, nimetus, tyyp) 
SELECT ltrim(rtrim(left(konto,6))) as konto, ltrim(rtrim(tp)), ltrim(rtrim(tegev)), ltrim(rtrim(allikas)), ltrim(rtrim(rahavoo)), db, kr, rekvid, timestamp, nimetus, 70
from tmp_saldoandmik
