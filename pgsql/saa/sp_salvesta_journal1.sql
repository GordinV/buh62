...
/*
select * from journal1 order by id desc limit 1
select * from hooettemaksud

select sp_koosta_hooettemaks(4474401, 1)

select * from hooleping where isikid =      35870
select sp_salvesta_journal1(5399827, 4474401, 100, '', 'test', '', '', '', '', '', '100100', '800402', '203630', '025003', 'EUR', 15.6466, 100, '', '')
