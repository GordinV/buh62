-- Function: fnckeskkutte(integer, integer)

-- DROP FUNCTION fnckeskkutte(integer, integer);

CREATE OR REPLACE FUNCTION fnckeskkutte(integer, integer, varchar)
  RETURNS numeric AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fnckeskkutte(integer, integer, varchar) OWNER TO vlad;
GRANT EXECUTE ON FUNCTION fnckeskkutte(integer, integer, varchar) TO dbpeakasutaja;
GRANT EXECUTE ON FUNCTION fnckeskkutte(integer, integer, varchar) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION fnckeskkutte(integer, integer, varchar) TO dbvaatleja;
